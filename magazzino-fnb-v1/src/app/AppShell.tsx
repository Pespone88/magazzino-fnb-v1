...
const sectionCopy: Record<NavigationKey, { title: string; description: string }> = {
  ...
  orders: { title: 'Ordini', description: 'Ordini fornitori, ricezioni DDT, carichi di magazzino e gestione difformità.' },
    ...
    if (activeSection === 'orders') {
      return (
        <section className="content-panel">
          ...
          <OrdersWorkspace catalogGateway={gateway} gateway={ordersGateway} storeId={activeStoreId} />
        </section>
      )
    }
